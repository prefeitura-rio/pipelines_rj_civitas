...
def task_build_messages_text(df: pd.DataFrame) -> List:
    ...
    filtered_df = df.loc[df["relationship"].str.lower() == "sim"]
...
- **Fonte:** {occurrence['id_source']}
- **ID:** {occurrence['id_report_original']}
- **Data:** {occurrence['data_report']}

- **Descrição:** {occurrence['descricao_report']}
- **Contexto:** {occurrence['nome_contexto']}
- **Motivo da relação:** {occurrence['relationship_explanation']}
        """
