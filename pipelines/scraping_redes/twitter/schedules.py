...
- Texto a ser analisado:''',
      ...
      FROM
       `rj-civitas.scraping_redes_staging.twitter_messages` WHERE LENGTH(text) > 0
)
...
fogo_cruzado_minutely_parameters = {
    ...
    "table_id_messages": "twitter_messages",
    "table_id_chats": "twitter_chats",
    "table_id_enriquecido": "twitter_enriquecido",
    "table_id_georreferenciado": "twitter_georreferenciado",
...
twitter_update_schedule = Schedule(clocks=untuple(twitter_interval_clocks))
