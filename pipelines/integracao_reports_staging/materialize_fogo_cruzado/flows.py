...
with Flow(
    name="CIVITAS: integracao_reports_staging - Materialize fogo cruzado",
    state_handlers=[
        handler_inject_bd_credentials,
        handler_initialize_sentry,
        handler_skip_if_running,
...
materialize_integracao_reports_fogo_cruzado.storage = GCS(constants.GCS_FLOWS_BUCKET.value)
materialize_integracao_reports_fogo_cruzado.run_config = KubernetesRun(
