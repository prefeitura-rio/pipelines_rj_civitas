-- AINDA ESTÁ RETORNANDO DUPLICADADE DE PONTO DE COLETA
-- SENTIDO VAZIO RETORNANDO DUAS LINHAS POR CAUSA DO GROUP BY
-- BAIRRO DIFERENTE PARA O MESMO PONTO DE COLETA ( COMENTEI POR AGORA, MAS PARA RESOLVER PODEMOS FAZER UM JOIN DA AVG LAT LONG COM A TABELA DE BAIRROS DO DATARIO)
